...
![(рис. 5. guest)](image/5.PNG){ #fig:005 width=70% height=70% }
...
![(рис. 9. Совпадение)](image/9.PNG){ #fig:009 width=70% height=70% }
...
![(рис. 10. cat /etc/passwd)](image/9.1.PNG){ #fig:010 width=70% height=70% }

![(рис. 11. cat /etc/passwd)](image/9.2.PNG){ #fig:010 width=70% height=70% }
...
![(рис. 17. Проверка директории d(000) и d(100) с правами файла 000)](image/16.PNG){ #fig:016 width=70% height=70% }
...
![(рис. 18. Проверка на минимальные необходимы права на создание поддиректории)](image/17.PNG){ #fig:017 width=70% height=70% }
